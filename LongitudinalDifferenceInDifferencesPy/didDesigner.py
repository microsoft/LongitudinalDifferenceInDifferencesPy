...
class DiDDesigner():
    ...
    def printPercentImprovement(self, df):
        ...
        print('percent improvement: ' + percentImprovement)
...
if __name__ == "__main__":
    ...
    # x=(kpiTreat1Post0_mean+(kpiTreat0Post1_mean-kpiTreat0Post0_mean))
    # y=kpiTreat1Post1_mean
    # percentImprovement=((y-x)/(x))*100
